          ...
          <div className="flex shadow-md my-10">
            <div className="w-3/4 bg-white px-10 py-10">
                    ...
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                      <div className="flex w-2/5">
                        ...
                        <div className="flex flex-col justify-between ml-4 flex-grow">
                          ...
                          <span className="text-orange-500 text-xs capitalize">{cart?.category}</span>
              ...
              <Link to={'/products'} className="flex font-semibold text-orange-600 text-sm mt-10">
                ...
                <svg className="fill-current mr-2 text-orange-500 w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z" /></svg>
                Continue Shopping
              </Link>
            </div>
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              ...
              <button className="bg-yellow-400 text-black hover:bg-yellow-600 px-5 py-2 text-sm hover:text-white font-semibold uppercase">Apply</button>
